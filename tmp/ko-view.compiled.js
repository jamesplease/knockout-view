...
(function( ko ) {
  ...
  if (context && !document.getElementById("ko-view-container")) {
    ...
    styleSheetTextNode.nodeValue = styleSheetText;
    koViewStyle.appendChild(styleSheetTextNode);
